...
Register = () =>{
    ...
    fetch('http://10.0.2.2:8000/api/volunteerregister', {
    method: 'POST',
    headers: {
    ...
    body: JSON.stringify({
      ...
      mobile_hospital_affiliation : this.state.hospital,
          ...
          <ScrollView contentContainerStyle={{flexGrow: 1}}>        
            <View style={{flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingLeft: 50, paddingRight: 50, paddingTop:10}}>          
              <View style={{marginBottom: 35, width: '100%'}}>
                <Text style={{fontSize: 24, fontWeight: 'bold', textAlign: 'center', width: '100%', color: '#2c3e50'}}>Volunteer</Text>
              </View>
        ...
        /> 
            ...
            <View style={{flex: 1, paddingLeft: 50, paddingRight: 50}}>
             ...
             <View style={{flex: 1, justifyContent: 'flex-end', alignItems: 'center', paddingLeft: 50, paddingRight: 50}}>
              ...
              <Item>
                  <Icon active name='ios-person' style={{color: '#687373',fontSize:15}} />
                  <Input placeholder='Mobile Hospital affiliation' style={{color: '#687373',fontSize:15}} onChangeText={(text) => this.setState({hospital: text})} placeholderTextColor="rgba(104, 115, 115,0.4)" />
              </Item> 
              <Item>
                  <Icon active name='ios-person' style={{color: '#687373',fontSize:15}} />
